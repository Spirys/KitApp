...
module.exports.DEFAULT_CHECKOUT_TIME_STUDENT_NOT_BESTSELLER = 3 * WEEK;
module.exports.DEFAULT_CHECKOUT_TIME_STUDENT_BESTSELLER = 2 * WEEK;
module.exports.DEFAULT_CHECKOUT_TIME_FACULTY = 4 * WEEK;
